<?php
    ...
    if(isset($_SESSION['userid']))
    {
        ...
        if($connect)
            $result = mysqli_query($connect,"SELECT * FROM posts WHERE userid = '{$_SESSION['userid']}'");
?>
<!DOCTYPE html>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="?logout=true">Logout</span></a>
            </li>
            <li class="nav-item active">
                <button class="btn btn-outline-success my-2 my-sm-0"><?php echo $_SESSION['full_name']; ?></button>
            </li>
            <li class="nav-item active">
            ...
            <div class="row">
                <div class="col-8 offset-2 post">
                    <div class="postPublisher">
                        <img class="postImg" src="../public/Images/<?php echo $_SESSION['pic'] ?>">
